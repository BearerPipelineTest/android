...
if [ $3 = $stableBranch ]; then
    ...
    findbugsResultNew="\n#<a href=\"https://www.kaminsky.me/nc-dev/$repository-findbugs/$6.html\">SpotBugs</a> (new)\n$(scripts/analysis/spotbugsSummary.py)\n"
    ...
    echo "JSON:"
    payload="{ \"body\" : \"$codacyResult $lintResult $findbugsResultNew $findbugsResultOld $checkLibraryMessage $lintMessage $findbugsMessage $gplayLimitation $notNull\" }"
    echo "$payload"
